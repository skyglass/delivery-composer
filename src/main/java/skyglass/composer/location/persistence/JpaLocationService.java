...
import skyglass.composer.location.Location;
import skyglass.composer.location.LocationService;
import skyglass.composer.location.LocationStore;
...
class JpaLocationService implements LocationService {
	...
	Location mapEntity(LocationEntity entity) {
		return new Location(entity.getUuid(), entity.getCity(), entity.getPostalCode(), entity.getStreet(), entity.getStreet2(),
